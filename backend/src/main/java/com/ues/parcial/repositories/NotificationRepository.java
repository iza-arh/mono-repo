...
public interface NotificationRepository extends JpaRepository <Notification, UUID>{
    ...
    public List<Notification> findByUser_Id(String id);
    ...
    public List<Notification> findByUser_IdAndStatusIgnoreCase(String userId, String status);

    // Find notifications for a specific user and notification channel. Ex: "userId" and "EMAIL"
	public List<Notification> findByUser_IdAndNotificationChannel(String userId, NotificationChannel channel);
	...
	public long countByUser_IdAndStatusIgnoreCase(String userId, String status);
	
	public void deleteByStatusIgnoreCase(String status);
	
	public void deleteByCreatedAtBefore(OffsetDateTime cutoff);
	
	public void deleteByUser_Id(String userId);
}